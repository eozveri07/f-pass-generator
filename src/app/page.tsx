...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Spotlight */}
      {isDarkMode && (
        <div className="absolute inset-0 z-30 hidden dark:block pointer-events-none">                    <SpotlightPreview />
        </div>
      )}
      
      {/* Content */}
      <div className="relative min-h-screen z-20 flex flex-col items-center justify-between p-8 font-[family-name:var(--font-geist-sans)]">        <div className="absolute inset-0 bg-gradient-to-b from-white/60 to-white/95 dark:from-black/60 dark:to-black/95 pointer-events-none"></div>
  ...
  <a href="https://fenrio.com" target="_blank" rel="noopener noreferrer">
